...
const BlogBannerMain = ({ postDetail }: { postDetail: SanityDocument }) => {
  ...
  const tPost = postDetail
    ? useTranslations(`Posts.${postDetail.title.en}`)
    : null

  // console.log(postDetail, 'fdshjfkjlshd')

  // const t = useTranslations(postDetail.title.vi)
        ...
        <div>
          <div className='flex items-center flex-wrap gap-3 mb-3'>
            ...
            <div className='flex items-center gap-1 text-xs sm:text-[18px]'>
              ...
              <Link href='/en/blog-detail/setup-react-typescript-with-vite-and-eslint'>
                English
              </Link>{' '}
              |{' '}
              <Link href='/vi/blog-detail/setup-react-typescript-with-vite-and-eslint'>
                Tiếng Việt
              </Link>
