...
import { Colors, Liquid } from '../ui/LiquidGradient'
...
const GitHubButton: React.FC = () => {
  ...
  return (
    <div className='flex justify-center mb-6 sticky z-20 cursor-pointer'>
      <a
        href='https://github.com/ui-layouts/uilayouts'
        target='_blank'
        className='relative inline-block  sm:w-[200px]  w-14 h-[2.7em] mx-auto group dark:bg-black bg-white dark:border-white border-black border-2 rounded-lg'
      >
        ...
        >
          <span className='flex items-center justify-between px-4  rounded-lg group-hover:text-yellow-400 text-white text-xl font-semibold tracking-wide whitespace-nowrap'>
            <Github className='inline-block group-hover:fill-yellow-400 fill-white w-6 h-6 flex-shrink-0' />
            <span className='sm:inline-block hidden text-[16px]'>
              PHONG PHAN
            </span>
          </span>
        </button>
