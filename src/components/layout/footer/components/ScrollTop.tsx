...
const ScrollTop = () => {
  ...
  return (
    <>
      <motion.span
        onClick={scrollToTop}
        className='scroll-top !bg-primary-color !border-none relative z-10 w-12 h-12 flex items-center justify-center rounded-full text-white cursor-pointer !-translate-y-10'
