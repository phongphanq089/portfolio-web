...
export function FloatingPanelTrigger({
  ...
  return (
    <motion.button
      ...
      className={cn(
        'flex h-9 items-center border border-zinc-950/10 bg-white px-3 text-zinc-950 dark:border-zinc-50/10  dark:text-zinc-50',
        className
      )}
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={cn(
              'fixed z-50 right-10 overflow-hidden border border-zinc-950/10 bg-white shadow-lg outline-none dark:border-zinc-50/10 dark:bg-zinc-800',
              className
            )}
            style={{
              borderRadius: 12,
              // left: triggerRect ? triggerRect.left : '10%',
