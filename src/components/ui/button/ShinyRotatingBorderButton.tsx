...
export const ShinyRotatingBorderButton = ({
  ...
  return (
    <button
      className={cn(
        'group relative overflow-hidden rounded-full  transition-transform active:scale-95 bg-neutral-600 p-1',
        className
      )}
      type='button'
      {...props}
    >
      ...
      <span className='relative z-10 block rounded-full  px-3 py-1 bg-neutral-800'>
        <motion.span
          animate={{
            backgroundImage: [
          ...
          className='transform-gpu bg-clip-text  text-sm tracking-tighter transition-colors duration-500 group-hover:text-transparent text-neutral-200'
          transition={{
            duration: 1,
            ease: 'linear',
            repeat: Number.POSITIVE_INFINITY,
