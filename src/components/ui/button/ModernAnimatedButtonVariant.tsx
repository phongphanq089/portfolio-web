  ...
  return (
    <button className='group relative bg-neutral-800 rounded-full p-px overflow-hidden'>
      ...
      <span className='flex items-center justify-center gap-1 relative z-[1] bg-neutral-950/90 rounded-full py-2 px-4 pl-2 w-full'>
        ...
        <span className='bg-gradient-to-b ml-1.5 from-white to-white/50  to-neutral-950/50 bg-clip-text text-xs text-transparent group-hover:scale-105 transition transform-gpu'>
          Giới thiệu
        </span>
      </span>
    </button>
